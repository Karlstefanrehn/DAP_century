...
cp -a /media/andy/Modelling/DAP_files/100_files/. /media/andy/Modelling/DAP_files/sims/ste_sims
cp -a /media/andy/Modelling/DAP_files/model_files/. /media/andy/Modelling/DAP_files/sims/ste_sims
cp -a /media/andy/Modelling/DAP_files/sch_files/ste_*.* /media/andy/Modelling/DAP_files/sims/ste_sims
cp -a /media/andy/Modelling/DAP_files/spin_base_sch/ste_*.* /media/andy/Modelling/DAP_files/sims/ste_sims
cp -a /media/andy/Modelling/DAP_files/wth_files/ste_*.* /media/andy/Modelling/DAP_files/sims/ste_sims
cp -a /media/andy/Modelling/DAP_files/site_files/ste_*.* /media/andy/Modelling/DAP_files/sims/ste_sims
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/"
fi
    
rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/*
...
cd /media/andy/Modelling/DAP_files/sims/ste_sims
...
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_summit_output/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/*
...
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_side_output/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/*
...
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/
mv /media/andy/Modelling/DAP_files/sims/ste_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/ste_toe_output/
