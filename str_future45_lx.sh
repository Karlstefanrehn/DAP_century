### THIS SHELL SCRIPT RUNS ROTATIONS 1,3,6,10 AND 11 ON ALL SLOPES AT THE STRATTON DAP SITE
...
if [ -d "/media/andy/Modelling/DAP_files/future_sims/str_sims45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/DAP_files/future_sims/str_sims45/"
fi

rm -r /media/andy/Modelling/DAP_files/future_sims/str_sims45/*

cp -a /media/andy/Modelling/DAP_files/100_files/. /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/model_files/. /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/sch_files/str_*.* /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/future_sch/str_*.* /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/spin_base_sch/str_*.* /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/wth_files/str_*.* /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/wth_files/Future/str_*_rcp45.wth /media/andy/Modelling/DAP_files/future_sims/str_sims45
cp -a /media/andy/Modelling/DAP_files/site_files/str_*.* /media/andy/Modelling/DAP_files/future_sims/str_sims45
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/"
fi
  
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/*
...
cd /media/andy/Modelling/DAP_files/future_sims/str_sims45
...
cp bcc_csm11m_rcp45.wth 09_100.wth
...
cp bcc_csm11_rcp45.wth 09_100.wth
...
cp CanESM2_rcp45.wth 09_100.wth
...
cp GFDL_ESM2G_rcp45.wth 09_100.wth
...
cp GFDL_ESM2M_rcp45.wth 09_100.wth
...
cp HadGEM2_CC_rcp45.wth 09_100.wth
...
cp HadGEM2_ES_rcp45.wth 09_100.wth
...
cp inmcm4_rcp45.wth 09_100.wth
...
cp IPSL_CM5ALR_rcp45.wth 09_100.wth
...
cp IPSL_CM5BLR_rcp45.wth 09_100.wth
...
cp MIROC5_rcp45.wth 09_100.wth
...
cp MIROC_CHEM_rcp45.wth 09_100.wth
...
cp MRI_CGCM3_rcp45.wth 09_100.wth
...
for f in *.lis; do mv "$f" "str_summit_$f"; done
for f in *.out; do mv "$f" "str_summit_$f"; done
for f in *.csv; do mv "$f" "str_summit_$f"; done

mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/*
...
for f in *.bin; do mv "$f" "str_summit_$f"; done
for f in *.lis; do mv "$f" "str_summit_$f"; done
for f in *.out; do mv "$f" "str_summit_$f"; done
for f in *.csv; do mv "$f" "str_summit_$f"; done

mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FW/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CFW/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWC/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/WCMF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/CMFW/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/MFWC/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/FWCM/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/OPP/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/str_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Stratton/Grass/RCP45/
...
for f in *.lis; do mv "$f" "str_side_$f"; done
for f in *.out; do mv "$f" "str_side_$f"; done
for f in *.csv; do mv "$f" "str_side_$f"; done
...
for f in *.bin; do mv "$f" "str_side_$f"; done
for f in *.lis; do mv "$f" "str_side_$f"; done
for f in *.out; do mv "$f" "str_side_$f"; done
for f in *.csv; do mv "$f" "str_side_$f"; done
...
for f in *.lis; do mv "$f" "str_toe_$f"; done
for f in *.out; do mv "$f" "str_toe_$f"; done
for f in *.csv; do mv "$f" "str_toe_$f"; done
...
for f in *.bin; do mv "$f" "str_toe_$f"; done
for f in *.lis; do mv "$f" "str_toe_$f"; done
for f in *.out; do mv "$f" "str_toe_$f"; done
for f in *.csv; do mv "$f" "str_toe_$f"; done
