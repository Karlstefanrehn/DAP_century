### THIS SHELL SCRIPT RUNS ROTATIONS 1,3,6,10 AND 11 ON ALL SLOPES AT THE WALSH DAP SITE
...
if [ -d "/media/andy/Modelling/DAP_files/future_sims/wal_sims45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/DAP_files/future_sims/wal_sims45/"
fi

rm -r /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*

cp -a /media/andy/Modelling/DAP_files/100_files/. /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/model_files/. /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/sch_files/wal_*.* /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/future_sch/wal_*.* /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/spin_base_sch/wal_*.* /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/wth_files/wal_*.* /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/wth_files/Future/wal_*_rcp45.wth /media/andy/Modelling/DAP_files/future_sims/wal_sims45
cp -a /media/andy/Modelling/DAP_files/site_files/wal_*.* /media/andy/Modelling/DAP_files/future_sims/wal_sims45
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/"
fi
  
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/*
...
cd /media/andy/Modelling/DAP_files/future_sims/wal_sims45
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FW/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CFW/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWC/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/WCMF/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/CMFW/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/MFWC/RCP45/

if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/FWCM/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/OPP/RCP45/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/"
fi
 
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/"
fi
   
rm -r /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/*
...
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.bin /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.lis /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.out /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/
mv /media/andy/Modelling/DAP_files/future_sims/wal_sims45/*.csv /media/andy/Modelling/Outputs/LAI_LX_Future/Walsh/Grass/RCP45/
