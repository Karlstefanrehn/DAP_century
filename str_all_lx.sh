...
cp -a /media/andy/Modelling/DAP_files/100_files/. /media/andy/Modelling/DAP_files/sims/str_sims
cp -a /media/andy/Modelling/DAP_files/model_files/. /media/andy/Modelling/DAP_files/sims/str_sims
cp -a /media/andy/Modelling/DAP_files/sch_files/str_*.* /media/andy/Modelling/DAP_files/sims/str_sims
cp -a /media/andy/Modelling/DAP_files/spin_base_sch/str_*.* /media/andy/Modelling/DAP_files/sims/str_sims
cp -a /media/andy/Modelling/DAP_files/wth_files/str_*.* /media/andy/Modelling/DAP_files/sims/str_sims
cp -a /media/andy/Modelling/DAP_files/site_files/str_*.* /media/andy/Modelling/DAP_files/sims/str_sims
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/"
fi
    
rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/*
...
cd /media/andy/Modelling/DAP_files/sims/str_sims
...
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_summit_output/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/*
...
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_side_output/
...
if [ -d "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/" ]; then
echo "Folder exists"
else
mkdir "/media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/"
fi

rm -r /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/*
...
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.bin /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.lis /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.out /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/
mv /media/andy/Modelling/DAP_files/sims/str_sims/*.csv /media/andy/Modelling/Outputs/LAI_LX_Outputs/str_toe_output/
